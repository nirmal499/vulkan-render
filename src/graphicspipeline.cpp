...
VkShaderModule GraphicsPipeline::createShaderModule(const std::vector<char>& code)
{
    ...
    if (vkCreateShaderModule(m_temp_device->get_logical_device(), &createInfo, nullptr, &shaderModule) != VK_SUCCESS) {
...
void GraphicsPipeline::create_graphics_pipeline()
{
    ...
    auto bindingDescription = COMMON::Vertex::getBindingDescription();
    auto attributeDescriptions = COMMON::Vertex::getAttributeDescriptions();
    ...
    if (vkCreatePipelineLayout(m_temp_device->get_logical_device(), &pipelineLayoutInfo, nullptr, &m_pipeline_layout) != VK_SUCCESS) {
